...
<?php include('class/insert.php'); ?>
<?php
$display = new display();
$insert = new insert();
$result =  $display->get_unread_msg($_SESSION['login_id'],$_SESSION['login_role']);

$all_result = $display->disp_all_msg($_SESSION['login_id'],$_SESSION['login_role']);
?>
			...
			<div class="tab-pane fade" id="all-msg" role="tabpanel" aria-labelledby="all-msg-tab">
				...
				<?php if(isset($_GET['msg'])): ?>
					...
					<?php if (mysqli_num_rows($result_msg)==1): ?>
						...
						<?php $insert->mark_as_read($row_msg['msg_id'],$_SESSION['login_id']); ?>
						<?php else: ?>
							<script>
